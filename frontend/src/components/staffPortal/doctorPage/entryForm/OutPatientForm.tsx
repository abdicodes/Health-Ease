...
import { OutpatientFormValues, EventTypes } from '../../../../types'
...
const OutpatientFormFields: React.FC<OutpatientFormProps> = () => {
  const formik = useFormikContext<OutpatientFormValues>()
...
const OutpatientForm: React.FC<OutpatientFormProps> = ({
  onSubmit,
  patientId,
}) => {
  const handleSubmit = (values: OutpatientFormValues) => {
  ...
  return (
    ...
    >
      <OutpatientFormFields onSubmit={handleSubmit} patientId={patientId} />
    </Formik>
  )
}
